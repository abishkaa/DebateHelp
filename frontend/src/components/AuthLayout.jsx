const AUTH_VARIANTS = {
  login: {
    ...
    heroText: 'Reconnect to your debate workspace, saved sessions, and coaching tools.',
  ...
  setup: {
    ...
    quote: 'Strategy turns pressure into clarity.',
  },
}
